                            ...
                            <Navbar bg="light" expand="lg">
                                <Container>
                                    ...
                                    <Navbar.Collapse className="justify-content-end">
                                        <Navbar.Text>
                                            <Form.Control className="me-auto" placeholder="Search" onChange={e => setSearchListItems(e.target.value)} /> {''}
                                        </Navbar.Text>
                                    </Navbar.Collapse>
                                    <Navbar.Collapse className="justify-content-end">
                                        <Navbar.Text>

                                            <DropdownButton title="Order" variant="primary">
                                                <Dropdown.Item onClick={() => { onOrderBy('title') }}>Name {(orderBy.campo == 'title') ? ((orderBy.order == 'asc') ? '🡩' : '🡣') : ''}</Dropdown.Item>
                                                <Dropdown.Item onClick={() => { onOrderBy('price') }}>Price {(orderBy.campo == 'price') ? ((orderBy.order == 'asc') ? '🡩' : '🡣') : ''}</Dropdown.Item>
                                            </DropdownButton>
